...
class Account{
    ...
    public boolean equals(Object o) {
        ...
        return userId == account.userId && Double.compare(balance, account.balance) == 0 && Objects.equals(name, account.name);
    }
...
class Bank{
    ...
    public boolean makeTransaction(Transaction t){
        ...
        if (t instanceof FlatAmountProvisionTransaction){
            FlatAmountProvisionTransaction p = (FlatAmountProvisionTransaction) t;
            provision = p.getFlatAmount();
        }
        else if (t instanceof FlatPercentProvisionTransaction){
            FlatPercentProvisionTransaction p = (FlatPercentProvisionTransaction) t;
            provision = p.getAmount() * p.getPercent() / 100.0;
        }

        if (from.getBalance() < amount + provision) return false;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass()) return false;
        Bank bank = (Bank) o;
        return Double.compare(totalTransfers, bank.totalTransfers) == 0 && Double.compare(totalProvisions, bank.totalProvisions) == 0 && Objects.equals(name, bank.name) && Objects.deepEquals(accounts, bank.accounts);
    }
