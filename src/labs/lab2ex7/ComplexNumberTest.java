...
class ComplexNumber<T extends Number,U extends Number> implements Comparable<ComplexNumber<T,U>>{
    ...
    public int compareTo(ComplexNumber<T, U> o) {
        double thisModul = this.modul();
        double otherModul = o.modul();
        return Double.compare(thisModul, otherModul);
    }
    ...
    public String toString() {
        ...
        return String.format("%.2f%s%.2fi",real.doubleValue(),operator, imaginary.doubleValue());
    }
}
