package prv_kolokvium.ex36_Car;
...
class Car{
    ...
    public Car(String manufecturer, String model, int price, float power) {
    ...
    public String toString() {
        return String.format("%s %s (%.0fKW) %d", manufecturer, model, power, price);
    }
}
...
class CarCollection{
    ...
    public List<Car> filterByManufacturer(String manufacturer){
        return cars.stream()
                .filter(c -> c.getManufecturer().equalsIgnoreCase(manufacturer))
