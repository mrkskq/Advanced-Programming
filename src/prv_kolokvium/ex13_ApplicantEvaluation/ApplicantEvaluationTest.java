package prv_kolokvium.ex13_ApplicantEvaluation;
...
class EvaluatorBuilder {
    public static Evaluator build(Evaluator.TYPE type) throws InvalidEvaluation {
        ...
        // вашиот код овде
        switch (type){
            case NO_CRIMINAL_RECORD: return a -> !a.hasCriminalRecord();
            case MORE_EXPERIENCE: return a -> a.getEmploymentYears() > 10;
            case MORE_CREDIT_SCORE: return a -> a.getCreditScore() >= 500;
            case NO_CRIMINAL_RECORD_AND_MORE_EXPERIENCE: return a -> !a.hasCriminalRecord() && a.getEmploymentYears() > 10;
            case MORE_EXPERIENCE_AND_MORE_CREDIT_SCORE: return a -> a.getEmploymentYears() >= 10 && a.getCreditScore() >= 500;
            case NO_CRIMINAL_RECORD_AND_MORE_CREDIT_SCORE: return a -> !a.hasCriminalRecord() && a.getCreditScore() >= 500;
            case INVALID: throw new InvalidEvaluation(type.toString());
        }
        return null;
    }
}
